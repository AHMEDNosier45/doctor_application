...
class CanceledReservationsView extends StatefulWidget {
  // final String patientId;
  const CanceledReservationsView({Key? key}) : super(key: key);

  @override
  State<CanceledReservationsView> createState() => _CanceledReservationsViewState();
}

class _CanceledReservationsViewState extends State<CanceledReservationsView> {
  final CancelledReservationsViewModel _viewModel = instance<CancelledReservationsViewModel>();
  ...
  Widget _getContentWidget() {
    return StreamBuilder<CancelledReservationsViewObject>(
      stream: _viewModel.outputReservations,
      builder: (context, snapshot) {
        if(snapshot.data != null) {
          List<ReservationModel> reservations = snapshot.data!.cancelledReservations;
